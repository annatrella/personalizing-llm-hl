...
def get_raw_dataset(dataset_name, output_path, seed, local_rank):
    if "ptweets/train_baseline" in dataset_name:
        return raw_datasets.PTweetsBaselineTrainDataset(output_path, seed,
                                                  local_rank, dataset_name)
    elif "ptweets/train_low" in dataset_name:
        return raw_datasets.PTweetsLowTrainDataset(output_path, seed,
                                                  local_rank, dataset_name)
    elif "ptweets/rm-baseline" in dataset_name:
        return raw_datasets.PtweetsRmDataset(output_path, seed,
                                                  local_rank, dataset_name)
