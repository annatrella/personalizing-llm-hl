...
class PTweetsBaselineTrainDataset(PromptRawDataset):
    def __init__(self, output_path, seed, local_rank, dataset_name):
        super().__init__(output_path, seed, local_rank, 'local/jsonfile')
        self.dataset_name = 'local_ptweets_baseline_train'
        self.dataset_name_clean = "ptweets_baseline_train"
        # imports data from local json file
        self.raw_datasets = self._load_json(DATA_PATH + "/ptweets_base_train.json")
...
class PTweetsLowTrainDataset(PromptRawDataset):
    def __init__(self, output_path, seed, local_rank, dataset_name):
        super().__init__(output_path, seed, local_rank, 'local/jsonfile')
        self.dataset_name = 'local_ptweets_low_train'
        self.dataset_name_clean = "ptweets_low_train"
        # imports data from local json file
        self.raw_datasets = self._load_json(DATA_PATH + "/ptweets_low_train.json")
...
# English dataset
class PtweetsRmDataset(PromptRawDataset):
    def __init__(self, output_path, seed, local_rank, dataset_name):
        super().__init__(output_path, seed, local_rank, 'local/jsonfile')
        self.dataset_name = 'local_ptweets_rm'
        self.dataset_name_clean = "ptweets_rm"
        # imports data from local json file
        self.raw_datasets = self._load_json(DATA_PATH + "/rm_baseline_data.json")
